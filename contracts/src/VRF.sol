...
contract VRF is RandomnessConsumer {
...
uint256 public MIN_PARTICIPANTS = 4;
...
uint256 public MAX_PARTICIPANTS = 100;
...
function startLottery(uint256 fee) external payable onlyOwner {
